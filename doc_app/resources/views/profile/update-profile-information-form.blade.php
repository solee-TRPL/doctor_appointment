<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="experience" type="number" min="0" max="60" class="mt-1 block w-full" wire:model.defer="state.experience" required autocomplete="experience" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="category" type="text" class="mt-1 block w-full" wire:model.defer="state.category" required autocomplete="category" />
